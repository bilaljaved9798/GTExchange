using GTWeb.AccountsServiceReference;
...
namespace GTWeb.Controllers
{
    ...
    public class DashBoardController : ApiController
    {
        ...
        public IHttpActionResult GetUserData()
        {
            ...
            {              
               ...
               // string accountbalance = objUsersServiceCleint.GetCurrentBalancebyUser(LoggedinUserDetail.UserID, ConfigurationManager.AppSettings["PasswordForValidate"]);
                LoggedinUserDetail.CurrentAccountBalance = Convert.ToDouble(0.00);
        ...
        [HttpGet]
        public IHttpActionResult GetBalnceDetails()
        {
            if (LoggedinUserDetail.GetUserID() > 0)
            {
        ...
        public IHttpActionResult GetDefaultPageData()
        {
            try
            {
                ...
                //var results = objUsersServiceCleint.GetInPlayMatcheswithRunners(userid);
                ...
                var todayhorserace = JsonConvert.DeserializeObject<List<Models.TodayHorseRacing>>(objUsersServiceCleint.GetTodayHorseRacing(LoggedinUserDetail.GetUserID(), "7"));
                todayhorserace = todayhorserace.Skip(5).Take(20).ToList();
                ...
                model.TodayGreyRacing = getmarkets();//new List<TodayHorserace>();
                ...
                ////todaygreyrace = todaygreyrace.Skip(5).Take(20).ToList();
            ...
            catch (System.Exception ex)
            {
                ...
                return Ok(new DefaultPageModel());
            }
        }
        ...
        [HttpGet]
        public IHttpActionResult ManageUser()
        {
            LoggedinUserDetail.CheckifUserLogin();
        ...
        [HttpGet]
        public IHttpActionResult CuttingUsers()
        {
        ...
        [HttpGet]
        public IHttpActionResult ProfitandLoss(string DateFrom, string DateTo, int UserID, bool chkseassion, bool chkfancy, bool chkByMarket, bool chkByMarketCricket)
        {
        ...
        [HttpGet]
        public IHttpActionResult showcompletedevent(string DateFrom, string DateTo, string useridd, string eventtype)
        {
            Decimal TotAdminAmount = 0;
            ...
            if (eventtype != "")
            {
                List<GTWeb.AccountsServiceReference.SP_UserAccounts_GetDatabyUserIDandDateRangeandEventType_Result> results = new List<GTWeb.AccountsServiceReference.SP_UserAccounts_GetDatabyUserIDandDateRangeandEventType_Result>();
                if (LoggedinUserDetail.GetUserTypeID() == 1)
                {
        ...
        public IHttpActionResult UserBetsbyAgent()
        {
            if (LoggedinUserDetail.GetUserTypeID() != 3)
            {
                if (LoggedinUserDetail.GetUserTypeID() == 2)
        ...
        public IHttpActionResult LedgerDetails(string DateFrom, string DateTo, int UserID, bool isCredit)
        {
            LoggedinUserDetail.CheckifUserLogin();
            try
            {
        ...
        public IHttpActionResult BalanceSheet(int UserID, bool isCredit)
        {
            LoggedinUserDetail.CheckifUserLogin();
            try
            {
