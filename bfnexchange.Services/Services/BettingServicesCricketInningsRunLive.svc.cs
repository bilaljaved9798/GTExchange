...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "BettingServicesCricketInningsRunLive" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select BettingServicesCricketInningsRunLive.svc or BettingServicesCricketInningsRunLive.svc.cs at the Solution Explorer and start debugging.
    [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple, InstanceContextMode = InstanceContextMode.PerCall)]
    [AspNetCompatibilityRequirements(
      RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class BettingServicesCricketInningsRunLive : IBettingServicesCricketInningsRunLive
    {
        ...
        public void GetCurrentMarketBookCricketlive(string Password)
        {
            try
            {
                ...
                {
                    //APIConfig.LiveCricketMarketBooksFancy.Clear();
                    string marketIDs = dbEntities.SP_UserMarket_GetDistinctMarketsOpenedCricketInningsRuns().FirstOrDefault();
                    if (marketIDs != "")
                    {
