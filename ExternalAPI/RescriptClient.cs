...
namespace ExternalAPI
{
    public class RescriptClient : HttpWebClientProtocol, IClient
    {
        ...
        private static readonly string LIST_EVENT_METHOD = "listEvents";
        ...
        private static readonly string LIST_RUNNER_BOOK_METHOD = "SportsAPING/v1.0/listRunnerBook";
        ...
        private static readonly String SELECTIOIN_ID = "selectionId";
        ...
        public IList<EventResult> listEvents(MarketFilter marketFilter, string locale = null)
        {
            ...
            args[FILTER] = marketFilter;
            args[LOCALE] = locale;
            return Invoke<List<EventResult>>(LIST_EVENT_METHOD, args);
        ...
        public IList<MarketBook> listRunnerBook(string marketId, string selectionId, PriceProjection priceProjection, OrderProjection? orderProjection = null, MatchProjection? matchProjection = null, string currencyCode = null, string locale = null)
        {
            var args = new Dictionary<string, object>();
            args[MARKET_ID] = marketId;
            args[SELECTIOIN_ID] = selectionId;
            args[PRICE_PROJECTION] = priceProjection;
            args[ORDER_PROJECTION] = orderProjection;
            args[MATCH_PROJECTION] = matchProjection;
            args[LOCALE] = locale;
            args[CURRENCY_CODE] = currencyCode;
            return Invoke<List<MarketBook>>(LIST_RUNNER_BOOK_METHOD, args);
        }
        ...
        public T Invoke<T>(string method, IDictionary<string, object> args = null)
        {
            ...
            using (StreamReader reader = new StreamReader(stream, Encoding.UTF8))
            {
                ...
                if (response.StatusCode != HttpStatusCode.OK) {
                    throw ReconstituteException(JsonConvert.Deserialize<ExternalAPI.TO.Exception>(jsonResponse));
                }
        ...
        private static System.Exception ReconstituteException(ExternalAPI.TO.Exception ex)
        {
            var data = ex.Detail;
        ...
        {
            return new AccountFundsResponse();
        }
    }
}
